...
\begin{figure}[H]
    ...
    % \begin{subfigure}{0.45\textwidth}
    %     \centering
    %     \includegraphics[width=\textwidth]{SupFigS3b.pdf}
    %     \caption{量子比特Z脉冲失真校正后的激发概率}
    % \end{subfigure}
    \caption{
...
\begin{figure}[H]
    ...
    % \begin{subfigure}{0.45\textwidth}
    %     \centering
    \includegraphics[width=\textwidth]{SupFigS5.pdf}
    % \caption{中间耦合区间（$r \approx 1$）的耦合强度矩阵}
    % \end{subfigure}
    % \hfill
    % \begin{subfigure}{0.45\textwidth}
    %     \centering
    %     \includegraphics[width=\textwidth]{SupFigS6.pdf}
    %     \caption{强短程耦合区间（$r \approx 10$）的耦合强度矩阵}
    % \end{subfigure}
    \caption{
        \textbf{不同耦合区间的耦合强度矩阵。}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{SupFigS7.pdf}
    \caption{
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{SupFigS8.pdf}
    \caption{
        \textbf{准分布函数的动力学。}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{SupFigS9.pdf}
    \caption{
        \textbf{线性势下遍历性破缺的指标。}
